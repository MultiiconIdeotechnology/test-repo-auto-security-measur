...
export class HolidayVersionTwoService {
  ...
  delete(id: any): Observable<any[]> {
    return this.http.post<any[]>(this.baseUrl + 'product/delete', { id: id });
  } // ----

  // --
  setAuditUnaudit(id: any) {
    return this.http.post<any[]>(this.baseUrl + 'product/setAudit', { id: id });
  } //--

  //----
  setHolidayPopular(id: string): Observable<any> {
    return this.http.post<any[]>(this.baseUrl + 'product/setPopular', { id: id });
  } // ---

  setHolidayPublish(id: any): Observable<any[]> {
    return this.http.post<any[]>(this.baseUrl + 'product/setPublishUnPublishForBonton', {id:id});
  }

  getHolidaysSearchDetail(model: any): Observable<any> {
    return this.http.post<any>(environment.apiUrl + "product/holidayDetail", model);
  } //
  ...
  getHolidayProductList(model: any): Observable<any> {
    return this.http.post<any>(this.baseUrl + 'product/getProductList', model);
  }
  ...
  getProductPricing(model: any): Observable<any> {
    return this.http.post<any>(environment.apiUrl + "product/getProductPricing", model);
  }
