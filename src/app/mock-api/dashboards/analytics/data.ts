            ...
            'thisyear': [
                {
                    name: 'Pax',
                    data: [
                        { x: new Date(2024, 1, 1), y: 4884 },
                        { x: new Date(2024, 2, 1), y: 5351 },
                        { x: new Date(2024, 3, 1), y: 5293 },
                        // { x: new Date(2024, 4, 1), y: 6520 },
                        // { x: new Date(2024, 5, 1), y: 9856 },
                        // { x: new Date(2024, 6, 1), y: 2541 },
                        // { x: new Date(2024, 7, 1), y: 6520 },
                        // { x: new Date(2024, 8, 1), y: 9856 },
                        // { x: new Date(2024, 9, 1), y: 2488 },
                        // { x: new Date(2024, 10, 1), y: 9687 },
                        // { x: new Date(2024, 11, 1), y: 2365 },
                        // { x: new Date(2024, 12, 1), y: 5841 },
                    ]
                }
            ],
            // 'lastyear': [
