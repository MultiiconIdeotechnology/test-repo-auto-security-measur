...
@Component({
  selector: 'app-crm-basic-details',
  templateUrl: './crm-basic-details.component.html',
  styleUrls: ['./crm-basic-details.component.scss'],
  standalone: true,
  imports: [
    NgIf,
    NgFor,
...
export class CrmBasicDetailsComponent {
