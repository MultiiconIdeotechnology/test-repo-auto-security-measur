...
@Component({
    selector: 'app-agent-rmlogs',
    templateUrl: './rmlogs.component.html',
    styles: [
        `
        .tbl-grid {
            grid-template-columns: 110px 150px 150px 310px;
        }
    `,
    ],
    standalone: true,
...
export class AgentRMLogsComponent {
    cols = [];
    total = 0;
    ...
    constructor(
        public matDialogRef: MatDialogRef<AgentRMLogsComponent>,
    ...
    refreshItems() {
        ...
        this.agentService.relationshipManagerLogsList(filterReq).subscribe({
            next: (data) => {
