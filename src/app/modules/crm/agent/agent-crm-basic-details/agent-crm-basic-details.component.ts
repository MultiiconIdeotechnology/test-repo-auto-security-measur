...
@Component({
  selector: 'app-agent-crm-basic-details',
  templateUrl: './agent-crm-basic-details.component.html',
  styleUrls: ['./agent-crm-basic-details.component.scss'],
  standalone: true,
  imports: [
    NgIf,
    NgFor,
...
export class AgentCrmBasicDetailsComponent {
