...
export class AirlineSummaryComponent extends BaseListingComponent implements OnDestroy {
  ...
  exportExcel(): void {
    if (!Security.hasExportDataPermission(module_name.airline_summary)) {
    ...
    this.airlineSummaryService.airlineSummary(filterReq).subscribe(data => {
      const formattedData = data.data.map(dt => ({
        supplier: dt.supplier,
        totalPax: dt.pax,
        totalPNR: dt.pnr,
        totalVolume: dt.volume,
        totalWeightage: dt.weightage + '%',
        domesticPax: dt.domestic_Pax,
        domesticPNR: dt.domestic_PNR,
        domesticVolume: dt.domestic_Volume,
        domesticWeightage: dt.domestic_Weightage + '%',
        domesticRatio: dt.domestic_Ratio + '%',
        internationalPax: dt.international_Pax,
        internationalPNR: dt.international_PNR,
        internationalVolume: dt.international_Volume,
        internationalWeightage: dt.international_Weightage + '%',
        internationalRatio: dt.international_Ratio + '%'
      }));
      ...
      const columns = [
        ...
        { header: 'Total PNR', property: 'totalPNR' },
        { header: 'Total Volume', property: 'totalVolume' },
        { header: 'Total Weightage (%)', property: 'totalWeightage' },
        { header: 'Domestic Pax', property: 'domesticPax' },
        { header: 'Domestic PNR', property: 'domesticPNR' },
        { header: 'Domestic Volume', property: 'domesticVolume' },
        { header: 'Domestic Weightage (%)', property: 'domesticWeightage' },
        { header: 'Domestic Ratio (%)', property: 'domesticRatio' },
        { header: 'International Pax', property: 'internationalPax' },
        { header: 'International PNR', property: 'internationalPNR' },
        { header: 'International Volume', property: 'internationalVolume' },
        { header: 'International Weightage (%)', property: 'internationalWeightage' },
