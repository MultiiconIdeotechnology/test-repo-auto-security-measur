...
import { CrmTravelBasicDetailsComponent } from "../crm-travel-basic-details/crm-travel-basic-details.component";
...
import { CrmTechBasicDetailsComponent } from "../crm-tech-basic-details/crm-tech-basic-details.component";
...
@Component({
    selector: 'app-tech-dial-call-list',
    templateUrl: './tech-dial-call-list.component.html',
    styleUrls: ['./tech-dial-call-list.component.scss'],
    standalone: true,
    imports: [
    NgIf,
    NgFor,
    ...
    TravelDialCallEntryComponent,
    TravelCallHistoryComponent,
    CrmTechBasicDetailsComponent,
    TechDialCallEntryComponent,
    TechCallHistoryComponent
]
})
export class DialTechCallListComponent {
    ...
    constructor(
        public matDialogRef: MatDialogRef<TravelDialCallEntryComponent>,
