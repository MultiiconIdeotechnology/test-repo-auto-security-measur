...
@Component({
    selector: 'app-agent-status-changed-log',
    templateUrl: './status-changed-log.component.html',
    styles: [
        `
        .tbl-grid {
...
export class AgentStatusChangedLogComponent {
    cols = [];
    total = 0;
    ...
    constructor(
        public matDialogRef: MatDialogRef<AgentStatusChangedLogComponent>,
