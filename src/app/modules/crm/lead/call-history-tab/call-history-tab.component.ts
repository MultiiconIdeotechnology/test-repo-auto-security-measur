...
@Component({
    selector: 'app-call-history-tab',
    templateUrl: './call-history-tab.component.html',
    standalone: true,
    styles: [
        `
        .tbl-grid {
...
export class CallHistoryTabComponent {
    dataList = [];
    MasterId: any;
    ...
    constructor(
        public matDialogRef: MatDialogRef<CallHistoryTabComponent>,
        private crmService: CrmService,
        private alertService: ToasterService,
        @Inject(MAT_DIALOG_DATA) public data: any = {},
        @Inject(MAT_DIALOG_DATA) public callHistoryHeader: any = {},
