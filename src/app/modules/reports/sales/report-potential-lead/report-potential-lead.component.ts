...
import { MarketingMaterialsComponent } from 'app/modules/crm/lead/marketing-materials/marketing-materials.component';
import { ScheduleCallRemarkComponent } from 'app/modules/crm/lead/call-history-tab/schedule-call-details/schedule-call-details.component';

@Component({
  selector: 'app-report-potential-lead',
  standalone: true,
  imports: [
    NgIf,
    NgFor,
  ...
  templateUrl: './report-potential-lead.component.html',
  styleUrls: ['./report-potential-lead.component.scss']
})
