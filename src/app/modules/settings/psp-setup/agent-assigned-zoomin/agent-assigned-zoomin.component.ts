...
@Component({
  selector: 'app-agent-assigned-zoomin',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './agent-assigned-zoomin.component.html',
  styleUrls: ['./agent-assigned-zoomin.component.scss']
})
export class AgentAssignedZoominComponent extends BaseListingComponent {
  ...
  constructor(
    public matDialogRef: MatDialogRef<AgentAssignedZoominComponent>,
