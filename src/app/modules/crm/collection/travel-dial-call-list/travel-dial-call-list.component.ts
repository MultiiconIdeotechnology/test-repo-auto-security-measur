...
@Component({
    selector: 'app-travel-dial-call-list',
    templateUrl: './travel-dial-call-list.component.html',
    styleUrls: ['./travel-dial-call-list.component.scss'],
    standalone: true,
    imports: [
    NgIf,
    NgFor,
...
export class DialTravelCallListComponent {
