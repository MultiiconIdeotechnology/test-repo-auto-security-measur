...
@Component({
    selector: 'app-crm-travel-dial-call-entry',
    templateUrl: './travel-dial-call-entry.component.html',
    standalone: true,
    imports: [
        NgIf,
        NgFor,
...
export class TravelDialCallEntryComponent extends BaseListingComponent implements OnDestroy {
    readonly: boolean = false;
    record: any = {};
    btnTitle: string = 'Create';
    fieldList: {};
    collectionListRoute = Routes.crm.collections_route;
    ...
    submit(): void {
        ...
        if (this.readonly) {
            this.router.navigate([this.collectionListRoute]);
            return;
        }
