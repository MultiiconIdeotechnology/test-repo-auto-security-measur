...
export class ReceiptComponent extends BaseListingComponent {
  ...
  columns = [
    ...
    { key: 'receipt_to', name: 'To', is_date: false, date_formate: '', is_sortable: true, class: '', is_sticky: false, indicator: false, is_boolean: false, tooltip: true },
  ...
  refreshItems() {
    ...
    this.offlineService.getOsbReceiptList(this.getFilter()).subscribe(
      {
        next: data => {
