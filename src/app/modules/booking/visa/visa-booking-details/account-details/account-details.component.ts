...
@Component({
  ...
  styles: [
    `.mdc-data-table__cell, .mdc-data-table__header-cell {
      ...
      .tbl-grid {
          grid-template-columns: 40px 180px 250px 180px 210px 110px;
      }`
  ]
})
export class AccountDetailsComponent {
  ...
  credit = new MatTableDataSource();
  debit = new MatTableDataSource();
  ...
  TabList: any[] = [
    ...
    { id: 3, name: 'Credit', isSelected: true },
    { id: 4, name: 'Debit', isSelected: true },
  ];
