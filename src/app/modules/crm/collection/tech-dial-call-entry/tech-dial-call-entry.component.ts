...
@Component({
    selector: 'app-crm-tech-dial-call-entry',
    templateUrl: './tech-dial-call-entry.component.html',
    standalone: true,
    imports: [
        NgIf,
        NgFor,
...
export class TechDialCallEntryComponent extends BaseListingComponent implements OnDestroy {
    ...
    constructor(
        public matDialogRef: MatDialogRef<TechDialCallEntryComponent>,
