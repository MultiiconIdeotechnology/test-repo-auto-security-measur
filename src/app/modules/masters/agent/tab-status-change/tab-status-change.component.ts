...
@Component({
  selector: 'app-tab-status-change',
  standalone: true,
  imports: [
    NgIf,
    NgFor,
  ...
  templateUrl: './tab-status-change.component.html',
  styleUrls: ['./tab-status-change.component.scss']
})
export class TabStatusChangeComponent {
  ...
  refreshItems(): void {
    ...
    request['module_for_id'] = this.idUrl;
