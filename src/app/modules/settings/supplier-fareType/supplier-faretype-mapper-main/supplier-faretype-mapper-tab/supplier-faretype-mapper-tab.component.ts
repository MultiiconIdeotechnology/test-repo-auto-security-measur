...
export class SupplierFaretypeMapperTabComponent extends BaseListingComponent {
  ...
  constructor(
    ...
    this.sortColumn = 'supplier_fare_type';
  ...
  refreshItems(event?: any): void {
    ...
    this.commonFareTypeService.getSupplierFareTypeMapperList(filterReq).subscribe({
      next: (data) => {
  ...
  editSupplierFareType(record: any): void {
    this.sidebarDialogService.openModal('Supplier common-fareType-edit', { data: record, title: 'Modify', edit: true });
  }
