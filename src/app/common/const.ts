...
export const Routes = {
    ...
    reports: {
        ...
        products_collection_path: 'reports/prod-collection',
        products_collection_route: 'reports/prod-collection',

        products_receipts_path: 'reports/prod-receipts',
        products_receipts_route: 'reports/prod-receipts'
    },
